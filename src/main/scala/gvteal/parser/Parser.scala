...
//     var preProcessedSrc = Preprocessor.preProcess(src);
//     println(preProcessedSrc)
//     val parser = new Parser(preProcessedSrc)
//     fastparse.parse(preProcessedSrc, parser.program(_))
//   }

//   def parseIndent(src: String) = {
//     val parser = new Parser(src)
//     fastparse.parse(src, parser.expr(_))
//   }
